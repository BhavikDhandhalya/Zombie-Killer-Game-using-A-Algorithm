...
def interaction(screen, survivor):
    ...
    Mpos = pygame.mouse.get_pos() # [x, y]  #it will return x, y pos
    Mx = Mpos[0] / Tile.width
    My = Mpos[1] / Tile.height

    for event in pygame.event.get(): #creating exit event for our game
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_e: #to change the weapon

                survivor.current += 1
                survivor.current %= 3

    """
    Player or Survivor Movement
    """
